    ...
    <div class="container">
        <div class="row no-gutters slider-text align-items-end justify-content-center">
            <div class="col-md-9 ftco-animate pb-5 text-center">
                <h1 class="mb-3 bread">Tim Astungkara</h1>
                <p class="breadcrumbs"><span class="mr-2"><a href="home">Home <i
                                class="ion-ios-arrow-forward"></i></a></span> <span>Tim Astungkara<i
    ...
    <?php } ?>
            ...
            <div class="row justify-content-center nopad nomar ctr">
                ...
                <a href="foto-<?=$r['judul_seo']."-".$r['id_foto']?>">
                    <div class="staff-image-1" style="background-image: url(images/foto/<?=$r['gambar']?>);">
                    </div></a>
                </div>
                <div class="col-lg-7 nopad nomar ctr">
                <a href="foto-<?=$r['judul_seo']."-".$r['id_foto']?>"><h2><?=$r['judul']?></h2></a>
                    <h6><?=$r['kode_produk']?></h6>
                    <p><?=$r['deskripsi']?></p>
                </div>
            </div>
