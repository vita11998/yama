    ...
    <table id="my_table" class="table table-striped table-bordered">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><img src="../images/transportasi/small/<?php echo $row['gambar']; ?>"
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="harga_mulai">
                    </div>
                </div>
                 <div class="col-md-12">
                    <div class="form-group">
        ...
        <form action="transportasi" id="form-transportasi"  method="POST" enctype="multipart/form-data" >
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        <label for="">Profesi</label>
                        <input type="text" class="form-control" name="harga_mulai" value="<?php echo $data['harga_mulai'] ?>">
                    </div>
                </div>
                <div class="col-md-12">
                    <div class="form-group">
