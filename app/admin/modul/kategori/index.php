...
<a href="kategori-add" class="btn btn-primary"> <i class="fa fa-plus"></i> Tambah Data</a>
    ...
    <table id="my_table" class="table table-striped table-bordered">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><img src="../images/kategori/small/<?php echo $row['gambar']; ?>"
                        style="width:100px;margin:0 auto;display:block">
                </td>
                <td style="width:19%"><a href="kategori-edit-<?php echo $row['id_kategori'] ?>"
                        class="btn btn-warning "> <i class="fas fa-pencil-alt"></i> Edit</a>
                    <a onClick="javascript: return confirm('Yakin untuk Menghapus data ?');"
                        href="<?php echo $module; ?>-delete-<?php echo $row['id_kategori']; ?>"
...
<div class="card">
    <div class="card-body">
        <form action="kategori" id="form-kategori"  method="POST" enctype="multipart/form-data" >
...
<?php
	...
	case "addgallery":
?>
<form action="modul/kategori/aksi.php?module=<?php echo $module; ?>&act=addgallery" method="POST"
...
<?php
    break;
	case "editgallery":
	$gam =  $db->connection("SELECT * FROM gallery_kategori WHERE id_gallery = '$_GET[id]'  ")->fetch();
?>
    ...
    <div class="row">
        <div class="col-md-12 card">
            <div class="card-body">
                <div class="form-group">
                    <label>judul</label>
                    <input type="text" class="form-control" name="judul" value="<?php echo $gam['judul'] ?>">
                </div>
                <div class="form-group">
                    <input type="hidden" name="id" value="<?php echo $_GET['id'] ?>">
                    ...
                    <img style="height:300px"
                        src="../images/gallery_kategori/<?php echo $imgname2."-".$gam['gambar']?>">
                </div>
            </div>
        </div>
        <input type="submit" class="btn btn-info" value="Simpan Data">
