            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="page-edit-4"
                                aria-expanded="false">
                        ...
                        <!-- <li class="sidebar-item">
                            ...
                            <ul aria-expanded="false" class="collapse  first-level">
                                <li class="sidebar-item">
                                    <a class="sidebar-link waves-effect waves-dark sidebar-link" href="pesan"
                                        aria-expanded="false">
                                        <i class="sl-icon-phone"></i>
                                        <span class="hide-menu">List Konsultasi</span>
                                    </a>
                                </li>
                                <li class="sidebar-item">
                                    <a class="sidebar-link waves-effect waves-dark sidebar-link" href="page-edit-8"
                                        aria-expanded="false">
                                        <i class="sl-icon-picture"></i>
                                        <span class="hide-menu">Ketentuan Konsultas</span>
                                    </a>
                                </li>
                            </ul>
                        </li> -->
