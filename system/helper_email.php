...
<html>
    ...
    <body>
        <div class="wrapper">
            <div class="container">
                <div class="header">
                    <h1 class="title">Pesan Kontak dari Web astungkaralaw.com</h1>
                ...
                '.$data['message'].'
	                ...
	                <div class="privacy-policy">
	                    <p av:i18n="block"><a href="https://www.astungkaralaw.com">Astungkara Law</a></p>
	                </div>
            </div>
        </div>
    </body>
...
';
        ...
        $mail->Subject = $sender['subject'].' - '.$data['subject'];
        $mail->Body    = $pesan;
